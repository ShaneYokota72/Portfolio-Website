...
private:
    ...
    //determine if there are more pixel on left/right or top/bottom
    void morepixel();
    void VHline();
    ...
    double hsym;
    //top to bot ratio
    // above 1 would mean theres more on bottom
    double toptobot;
    // left to right ration
    // above 1 would mean theres more on right
    double lefttoright;
    double totalblack;
    double vcentroid;
    double hcentroid;
